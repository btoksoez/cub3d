...
/*   Updated: 2024/06/13 15:54:03 by andrealbuqu      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_textures_aux(t_game *game, t_textures *textures)
{
	...
	init_texture(game, &textures->enemy[1][0], "./assets/textures/boss/boss1.xpm");
	init_texture(game, &textures->enemy[1][1], "./assets/textures/boss/boss2.xpm");
	init_texture(game, &textures->enemy[1][2], "./assets/textures/boss/boss3.xpm");
	init_texture(game, &textures->enemy[1][3], "./assets/textures/boss/boss4.xpm");
	init_texture(game, &textures->enemy[2][0], "./assets/textures/rat/rat1.xpm");
	init_texture(game, &textures->enemy[2][1], "./assets/textures/rat/rat2.xpm");
	init_texture(game, &textures->enemy[2][2], "./assets/textures/rat/rat3.xpm");
	init_texture(game, &textures->enemy[2][3], "./assets/textures/rat/rat4.xpm");
}
...
void	init_textures(t_game *game, t_textures *textures)
{
	...
	init_texture(game, &textures->weapon[0][0], "./assets/textures/gun/gun1.xpm");
	init_texture(game, &textures->weapon[0][1], "./assets/textures/gun/gun2.xpm");
	init_texture(game, &textures->weapon[0][2], "./assets/textures/gun/gun3.xpm");
	init_texture(game, &textures->weapon[0][3], "./assets/textures/gun/gun4.xpm");
	init_texture(game, &textures->weapon[0][4], "./assets/textures/gun/gun5.xpm");
	init_texture(game, &textures->weapon[1][0], "./assets/textures/knife/knife1.xpm");
	init_texture(game, &textures->weapon[1][1], "./assets/textures/knife/knife2.xpm");
	init_texture(game, &textures->weapon[1][2], "./assets/textures/knife/knife3.xpm");
	init_texture(game, &textures->weapon[1][3], "./assets/textures/knife/knife4.xpm");
	init_texture(game, &textures->weapon[1][4], "./assets/textures/knife/knife5.xpm");
